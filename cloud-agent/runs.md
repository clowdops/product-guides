...
<figure><img src="../.gitbook/assets/cloud-agent-runs-list.png" alt=""><figcaption>Runs tab — source filter, status badges, token count, and cost columns</figcaption></figure>
